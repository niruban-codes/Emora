            ...
            children: [
              ...
              SizedBox(
                ...
                child: PieChart(PieChartData(sectionsSpace: 0, centerSpaceRadius: 35, sections: [
                  PieChartSectionData(color: Colors.yellow, value: 30, radius: 10, showTitle: false),       // Happy
                  PieChartSectionData(color: Colors.blue, value: 20, radius: 10, showTitle: false),         // Sad
                  PieChartSectionData(color: Colors.grey, value: 25, radius: 10, showTitle: false),         // Neutral
                  PieChartSectionData(color: Colors.green, value: 10, radius: 10, showTitle: false),        // Surprise
                  PieChartSectionData(color: Colors.purple, value: 10, radius: 10, showTitle: false),       // Fear
                  PieChartSectionData(color: Colors.orange, value: 5, radius: 10, showTitle: false),        // Angry
                ])),
              ),
  ...
  Widget _buildGenreByEmotionBar() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text("Top Recommended Genres", style: TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.bold)),
          ...
          SizedBox(
            ...
            child: BarChart(BarChartData(
              ...
              barGroups: [
                BarChartGroupData(x: 0, barRods: [BarChartRodData(toY: 8, color: const Color(0xFFD43FB1), width: 12)]),
                BarChartGroupData(x: 1, barRods: [BarChartRodData(toY: 12, color: const Color(0xFF6C5CE7), width: 12)]),
                BarChartGroupData(x: 2, barRods: [BarChartRodData(toY: 6, color: const Color(0xFF00FFCC), width: 12)]),
              ],
            )),
          ),
          const SizedBox(height: 10),
          const Center(child: Text("Pop / HipHop / R&B", style: TextStyle(fontSize: 12, color: Colors.white70))),
        ],
      ),
    );
  }
