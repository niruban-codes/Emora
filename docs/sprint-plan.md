...
**Project:** Emora — Emotion-Based Music Recommendation App  
**Team:** Group 01-FIS | Sabaragamuwa University of Sri Lanka  
...
| Phase     | Member           | Responsibility              |
| ----------| ---------------- | --------------------------- |
| Phase 1   | Niruban          | Firebase Auth — Build       |
